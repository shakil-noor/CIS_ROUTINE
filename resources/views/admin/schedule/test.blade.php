        ...
        <ul>
            ...
            <li class="cd-schedule__group">
                ...
                <ul>
                    ...
                    <li class="cd-schedule__event">
                        <a data-start="{{ $CS->start_time }}" data-end="{{ $CS->end_time }}" data-content="event-abs-circuit" data-event="event-1" href="#0">
                            <em class="cd-schedule__name">{{ $CS->course->title }}</em>
                            {{ $CS->room->room_no }}
                        </a>
                    </li>
                    @endforeach
            ...
            <li class="cd-schedule__group">
                ...
                <ul>
                    ...
                    <li class="cd-schedule__event">
                        <a data-start="12:00" data-end="01:30" data-content="event-rowing-workout" data-event="event-2" href="#0">
